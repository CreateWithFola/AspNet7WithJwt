...
namespace JWTAuthNet7.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        private string GenerateNewJsonWebToken(List<Claim> claims) {
            ...
            var tokenObjects = new JwtSecurityToken(
                issuer: _configuration["JWT:ValidUssuer"],
            ...
            string token =new JwtSecurityTokenHandler().WriteToken(tokenObjects);
            return token;
        }
